...
void main() {
  ...
  MaterialSliverSearchBar buildBar({bool isSearchActive = false}) =>
      MaterialSliverSearchBar(
        title: const Text('Habits'),
        leading: const Icon(Icons.info_outline, key: ValueKey('info')),
        actions: const [
          Icon(Icons.settings_outlined, key: ValueKey('settings')),
        ],
  ...
  testWidgets('compact layout preserves the 64 by 48 baseline', (tester) async {
