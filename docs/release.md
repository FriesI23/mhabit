# Release: pre-v1.27.8+197

> Includes updates since pre-v1.27.7+196. Compare with the previous stable
> release below for the complete beta changes.
...
[Full Changelog](https://github.com/FriesI23/mhabit/compare/v1.27.6+195...pre-v1.27.8+197)
