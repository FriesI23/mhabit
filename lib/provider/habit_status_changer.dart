...
class HabitStatusChangerViewModel with ChangeNotifier {
  ...
  HabitStatusChangerViewModel({List<HabitSummaryData>? dataList}) {
    if (dataList != null && dataList.isNotEmpty) updateDataColl(dataList);
  }

  void updateDataColl(List<HabitSummaryData> dataList,
      {bool needClear = false, bool listen = false}) {
