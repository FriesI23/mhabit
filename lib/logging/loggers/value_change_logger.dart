...
abstract interface class AppValueChangeLogger {
  ...
  factory AppValueChangeLogger(AppLoggerMananger m, LoggerType t,
...
class _AppValueChangeLogger implements AppValueChangeLogger {
  ...
  void debug(String name,
          ...
          Object? error,
          StackTrace? stackTrace}) =>
      parentLogger.debug(buildMsg(name, beforeVal, afterVal),
  ...
  void info(String name,
          ...
          Object? error,
          StackTrace? stackTrace}) =>
      parentLogger.info(buildMsg(name, beforeVal, afterVal),
          ex: ex, error: error, stackTrace: stackTrace);
  ...
  void warn(String name,
          ...
          Object? error,
          StackTrace? stackTrace}) =>
      parentLogger.warn(buildMsg(name, beforeVal, afterVal),
          ex: ex, error: error, stackTrace: stackTrace);
  ...
  void error(String name,
          ...
          Object? error,
          StackTrace? stackTrace}) =>
      parentLogger.error(buildMsg(name, beforeVal, afterVal),
          ex: ex, error: error, stackTrace: stackTrace);
  ...
  void fatal(String name,
          ...
          Object? error,
          StackTrace? stackTrace}) =>
      parentLogger.fatal(buildMsg(name, beforeVal, afterVal),
          ex: ex, error: error, stackTrace: stackTrace);
}
