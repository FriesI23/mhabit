...
part of 'habit_display_empty_image.dart';

// **************************************************************************
// CopyWithGenerator
// **************************************************************************

abstract class _$HabitDisplayEmptyImageStyleCWProxy {
...
/// Proxy class for `copyWith` functionality. This is a callable class and can be used as follows: `instanceOfHabitDisplayEmptyImageStyle.copyWith(...)`.
class _$HabitDisplayEmptyImageStyleCWProxyImpl
    implements _$HabitDisplayEmptyImageStyleCWProxy {
  const _$HabitDisplayEmptyImageStyleCWProxyImpl(this._value);
  ...
  HabitDisplayEmptyImageStyle call({
    ...
    Object? boardStrokeColor = const $CopyWithPlaceholder(),
    Object? fronBoardTopColor = const $CopyWithPlaceholder(),
    Object? fronBoardFirstLineColor = const $CopyWithPlaceholder(),
    Object? fronBoardOtherLineColor = const $CopyWithPlaceholder(),
    Object? fronBoardSubtitleLineColor = const $CopyWithPlaceholder(),
    Object? backgroundCirlcColor = const $CopyWithPlaceholder(),
  }) {
...
extension $HabitDisplayEmptyImageStyleCopyWith on HabitDisplayEmptyImageStyle {
  /// Returns a callable class that can be used as follows: `instanceOfHabitDisplayEmptyImageStyle.copyWith(...)`.
  // ignore: library_private_types_in_public_api
  _$HabitDisplayEmptyImageStyleCWProxy get copyWith =>
      _$HabitDisplayEmptyImageStyleCWProxyImpl(this);
}
