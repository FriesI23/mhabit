...
// in mhabit/test/unit/models/app_sync/webdav_app_sync_task_test.dart.
...
import 'package:mhabit/models/_app_sync_tasks/app_sync_task.dart' as _i8;
...
import 'package:mhabit/models/app_sync_server_form.dart' as _i7;
...
class _FakeConverter_0<S1, T1> extends _i1.SmartFake
  ...
  _FakeConverter_0(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}

class _FakeSink_1<T1> extends _i1.SmartFake implements Sink<T1> {
  _FakeSink_1(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}
...
class _FakeAppSyncServer_4 extends _i1.SmartFake implements _i3.AppSyncServer {
  _FakeAppSyncServer_4(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}
...
class _FakeWebDavAppSyncTaskResult_6 extends _i1.SmartFake
    implements _i5.WebDavAppSyncTaskResult {
  _FakeWebDavAppSyncTaskResult_6(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}
...
class MockConverter<S, T> extends _i1.Mock implements _i2.Converter<S, T> {
  ...
  T convert(S? input) =>
      (super.noSuchMethod(
            Invocation.method(#convert, [input]),
  ...
  Sink<S> startChunkedConversion(Sink<T>? sink) =>
      (super.noSuchMethod(
            Invocation.method(#startChunkedConversion, [sink]),
  ...
  @override
  _i4.Stream<T> bind(_i4.Stream<S>? stream) =>
      (super.noSuchMethod(
  ...
  @override
  _i2.Converter<RS, RT> cast<RS, RT>() =>
      (super.noSuchMethod(
...
class MockAppWebDavSyncServer extends _i1.Mock
  ...
  DateTime get createTime =>
      (super.noSuchMethod(
            ...
            returnValue: _FakeDateTime_2(this, Invocation.getter(#createTime)),
          )
          as DateTime);
  ...
  DateTime get modifyTime =>
      (super.noSuchMethod(
            ...
            returnValue: _FakeDateTime_2(this, Invocation.getter(#modifyTime)),
          )
          as DateTime);
  ...
  Uri get path =>
      (super.noSuchMethod(
            ...
            returnValue: _FakeUri_3(this, Invocation.getter(#path)),
          )
          as Uri);
  ...
  @override
  _i7.AppSyncServerForm toForm() =>
      (super.noSuchMethod(
            Invocation.method(#toForm, []),
            returnValue: _i6.dummyValue<_i7.AppSyncServerForm>(
              this,
              Invocation.method(#toForm, []),
            ),
          )
          as _i7.AppSyncServerForm);
...
///
/// See the documentation for Mockito's code generation for more information.
class MockAppSyncContext extends _i1.Mock implements _i8.AppSyncContext {
  MockAppSyncContext() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  _i3.AppSyncServer get config =>
      (super.noSuchMethod(
            Invocation.getter(#config),
            returnValue: _FakeAppSyncServer_4(this, Invocation.getter(#config)),
          )
          as _i3.AppSyncServer);

  @override
  _i8.AppSyncTaskStatus get status =>
      (super.noSuchMethod(
            Invocation.getter(#status),
            returnValue: _i8.AppSyncTaskStatus.idle,
          )
          as _i8.AppSyncTaskStatus);
  ...
  bool get isCancalling =>
      (super.noSuchMethod(Invocation.getter(#isCancalling), returnValue: false)
          as bool);
...
///
/// See the documentation for Mockito's code generation for more information.
class MockAppSyncSubTask<T> extends _i1.Mock implements _i8.AppSyncSubTask<T> {
  MockAppSyncSubTask() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.Future<T> run(_i8.AppSyncContext? context) =>
      (super.noSuchMethod(
            ...
            returnValue:
                ...
                _FakeFuture_5<T>(this, Invocation.method(#run, [context])),
          )
          as _i4.Future<T>);
}
...
class MockAppSyncSubTaskWithResult extends _i1.Mock
    implements _i8.AppSyncSubTask<_i5.WebDavAppSyncTaskResult> {
  @override
  _i4.Future<_i5.WebDavAppSyncTaskResult> run(_i8.AppSyncContext? context) =>
      (super.noSuchMethod(
            Invocation.method(#run, [context]),
            returnValue: _i4.Future<_i5.WebDavAppSyncTaskResult>.value(
              _FakeWebDavAppSyncTaskResult_6(
                this,
                Invocation.method(#run, [context]),
              ),
            ),
